...
export interface LinePlotProps<T> {
    ...
    /** Can be constant OR derived from data (e.g., scale by count). */
    pointRadius?: number | ((d: T, i: number) => number);
...
export default function LinePlot<T>({
    ...
    const getPointRadius = (d: T, i: number) =>
        typeof pointRadius === "function" ? pointRadius(d, i) : pointRadius;
    ...
    return (
        <svg width={width} height={height}>
            ...
            {/* Brush FIRST so points stay hoverable */}
