...
* Made script called organizeMoviesByYear.js to filter out unneeded data from the original csv and reformat 
...
I used ChatGPT to bounce ideas off of and help with debugging. I definitely had a hard time figuring out how to make the graphs affect one another, so it gave me several hints to move along the way. However, when I make sure to properly take the time to comprehend and break down what it gives me to make sure that it actually makes sense. I also found it helpful for writing JSDoc and good comments.